...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        pm.fullRecovery();
        pm.setThreshold(1000);
        //System.out.println(Integer.toString(pm.getCounterFromPrevTA()));
        System.out.println("Buffer threshold: " + Integer.toString(pm.getThreshold()));
        ...
        System.out.println("Buffer amount of current elements: "+Integer.toString(pm.getBufferSize()));
    }
